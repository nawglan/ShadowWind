...
#define SPECIAL(name) \
   int (name)(struct char_data *ch, void *me, int cmd, char *argument, int type)
...
#define AFF2_HASTE           (1 <<  8)  /* i Char is slow */
#define AFF2_LEVITATE        (1 <<  9)  /* j Char is slow */
...
struct char_point_data {
  ...
  int bank_plat; /* Gold the char has in a bank account     */
  int bank_gold; /* Gold the char has in a bank account     */
  int bank_silver; /* Gold the char has in a bank account     */
  int bank_copper; /* Gold the char has in a bank account     */
  int plat;
...
struct char_special_data {
  ...
  int skill_timer; /* Timer for fight update               */
