...
const struct command_info cmd_info[] = {
    ...
    {"north", POS_STANDING, do_move, 0, SCMD_NORTH, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED, 0},
    {"east", POS_STANDING, do_move, 0, SCMD_EAST, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED, 0},
    {"south", POS_STANDING, do_move, 0, SCMD_SOUTH, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED, 0},
    {"west", POS_STANDING, do_move, 0, SCMD_WEST, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED, 0},
    {"up", POS_STANDING, do_move, 0, SCMD_UP, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED, 0},
    {"down", POS_STANDING, do_move, 0, SCMD_DOWN, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED, 0},
    ...
    {"apply poison", POS_RESTING, do_applypoison, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"assist", POS_FIGHTING, do_assist, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"backstab", POS_STANDING, do_backstab, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"bandage", POS_STANDING, do_bandage, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"bash", POS_FIGHTING, do_bash, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"board", POS_STANDING, do_enter, 0, SCMD_BOARD, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED, 0},
    ...
    {"buy", POS_STANDING, do_not_here, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED, 0},
    {"bye", POS_RESTING, do_action, 0, 0, 0, 0, AFF2_SCRIBING | AFF2_CASTING, 0},

    {"cast", POS_FIGHTING, do_cast, 0, 0, 0, AFF_SILENCE | AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"camp", POS_RESTING, do_camp, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED | AFF2_KNOCKEDOUT, 0},
    ...
    {"chat", POS_SLEEPING, do_gen_comm, 0, SCMD_CHAT, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED, 0},
    ...
    {"circle", POS_FIGHTING, do_backstab, 0, SCMD_CIRCLE, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"close", POS_SITTING, do_close, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"deposit", POS_STANDING, do_not_here, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"disarm", POS_STANDING, do_disarm, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"disembark", POS_STANDING, do_leave, 0, SCMD_DISEMBARK, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED, 0},
    {"disengage", POS_FIGHTING, do_disengage, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"dismount", POS_SITTING, do_dismount, IMMORTAL, 0, COM_IMMORT, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"doh", POS_RESTING, do_action, 0, 0, 0, 0, AFF2_SCRIBING | AFF2_CASTING, 0},
    {"drag", POS_STANDING, do_drag, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"dream", POS_RESTING, do_action, 0, 0, 0, 0, AFF2_SCRIBING | AFF2_CASTING, 0},
    {"drink", POS_RESTING, do_drink, 0, SCMD_DRINK, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"drool", POS_RESTING, do_action, 0, 0, 0, 0, AFF2_SCRIBING | AFF2_CASTING, 0},
    {"drop", POS_RESTING, do_drop, 0, SCMD_DROP, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"eat", POS_RESTING, do_eat, 0, SCMD_EAT, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"enter", POS_STANDING, do_enter, 0, SCMD_ENTER, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED, 0},
    ...
    {"evaluate", POS_RESTING, do_evaluate, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"exchange", POS_STANDING, do_not_here, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"fill", POS_STANDING, do_pour, 0, SCMD_FILL, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"flee", POS_FIGHTING, do_flee, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"follow", POS_RESTING, do_follow, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"get", POS_RESTING, do_get, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"giggle", POS_RESTING, do_action, 0, 0, 0, 0, AFF2_SCRIBING | AFF2_CASTING, 0},
    {"give", POS_RESTING, do_give, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"grab", POS_RESTING, do_grab, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"group", POS_RESTING, do_group, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"hide", POS_RESTING, do_hide, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"hiss", POS_RESTING, do_action, 0, 0, 0, 0, AFF2_SCRIBING | AFF2_CASTING, 0},
    {"hit", POS_FIGHTING, do_hit, 0, SCMD_HIT, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"hold", POS_RESTING, do_grab, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"inventory", POS_RESTING, do_inventory, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED, 0},
    ...
    {"junk", POS_RESTING, do_drop, IMMORTAL, SCMD_JUNK, COM_IMMORT, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},

    {"kill", POS_FIGHTING, do_kill, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"kick", POS_FIGHTING, do_kick, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"leave", POS_STANDING, do_leave, 0, SCMD_LEAVE, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED, 0},
    ...
    {"lock", POS_SITTING, do_lock, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"mount", POS_STANDING, do_mount, IMMORTAL, 0, COM_IMMORT, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"mpcast", POS_DEAD, do_mpcast, 0, 0, COM_MOB, AFF_SILENCE | AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_MINOR_PARALIZED, 0},
    ...
    {"mpechoaround", POS_DEAD, do_mpechoaround, 0, 0, COM_MOB, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_MINOR_PARALIZED, 0},
    ...
    {"mptransfer", POS_DEAD, do_mptransfer, 0, 0, COM_MOB, AFF_MAJOR_PARALIZED, AFF2_SCRIBING | AFF2_MINOR_PARALIZED,
     0},
    {"murder", POS_FIGHTING, do_hit, 0, SCMD_MURDER, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"open", POS_SITTING, do_open, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"order", POS_RESTING, do_order, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"pick", POS_STANDING, do_pick, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"pour", POS_STANDING, do_pour, 0, SCMD_POUR, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"pout", POS_RESTING, do_action, 0, 0, 0, 0, AFF2_SCRIBING | AFF2_CASTING, 0},
    {"practice", POS_RESTING, do_practice, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"put", POS_RESTING, do_put, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"quaff", POS_RESTING, do_use, 0, SCMD_QUAFF, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"recite", POS_RESTING, do_use, 0, SCMD_RECITE, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"receive", POS_STANDING, do_not_here, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"remove", POS_RESTING, do_remove, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"rent", POS_STANDING, do_not_here, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"rescue", POS_FIGHTING, do_rescue, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"rest", POS_RESTING, do_rest, 0, 0, 0, AFF_MAJOR_PARALIZED, AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED,
     0},
    ...
    {"roundhouse", POS_FIGHTING, do_roundhouse, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"ruffle", POS_RESTING, do_action, 0, 0, 0, AFF_MAJOR_PARALIZED, AFF2_SCRIBING | AFF2_CASTING, 0},

    {"sacrifice", POS_STANDING, do_sac, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"scout", POS_STANDING, do_scout, 0, 0, 0, AFF_MAJOR_PARALIZED, AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED,
     0},
    ...
    /*
    {"scribe", POS_RESTING, do_scribe, 0, SCMD_MAGE, 0, AFF_CAMPING | AFF_MAJOR_PARALIZED, AFF2_SCRIBING | AFF2_CASTING
    | AFF2_MINOR_PARALIZED | AFF2_WRAITHFORM, 0},
     */
    {"search", POS_RESTING, do_search, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED, 0},
    ...
    {"sell", POS_STANDING, do_not_here, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"shout", POS_RESTING, do_gen_comm, 0, SCMD_SHOUT, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED, 0},
    ...
    {"sing", POS_RESTING, do_cast, 0, SCMD_SING, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"sip", POS_RESTING, do_drink, 0, SCMD_SIP, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"sit", POS_RESTING, do_sit, 0, 0, 0, AFF_MAJOR_PARALIZED, AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED, 0},
    {"skills", POS_RESTING, do_practice, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"sleep", POS_RESTING, do_sleep, 0, 0, 0, AFF_MAJOR_PARALIZED, AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED,
     0},
    ...
    {"sneak", POS_STANDING, do_sneak, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"specialize", POS_RESTING, do_practice, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"split", POS_SITTING, do_split, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"stand", POS_RESTING, do_stand, 0, 0, 0, AFF_MAJOR_PARALIZED, AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED,
     0},
    ...
    {"steal", POS_STANDING, do_steal, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"take", POS_RESTING, do_get, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"target", POS_FIGHTING, do_target, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"tarzan", POS_RESTING, do_action, 0, 0, 0, 0, AFF2_SCRIBING | AFF2_CASTING, 0},
    {"taste", POS_RESTING, do_eat, 0, SCMD_TASTE, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"track", POS_STANDING, do_track, 0, 0, 0, AFF_MAJOR_PARALIZED, AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED,
     0},
    {"train", POS_RESTING, do_practice, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"ungroup", POS_RESTING, do_ungroup, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"unlock", POS_SITTING, do_unlock, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"use", POS_SITTING, do_use, 0, SCMD_USE, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    {"users", POS_DEAD, do_users, IMMORTAL, 0, COM_IMMORT, 0, AFF2_SCRIBING | AFF2_CASTING, 0},

    {"value", POS_STANDING, do_not_here, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"visible", POS_RESTING, do_visible, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"wake", POS_SLEEPING, do_wake, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_KNOCKEDOUT | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"wear", POS_STANDING, do_wear, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"wield", POS_RESTING, do_wield, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"withdraw", POS_STANDING, do_not_here, 0, 0, 0, AFF_MAJOR_PARALIZED,
     AFF2_SCRIBING | AFF2_CASTING | AFF2_WRAITHFORM | AFF2_MINOR_PARALIZED, 0},
    ...
    {"write", POS_STANDING, do_write, 0, 0, 0, AFF_MAJOR_PARALIZED, AFF2_SCRIBING | AFF2_CASTING | AFF2_MINOR_PARALIZED,
     0},
...
void command_interpreter(struct char_data *ch, char *argument) {
  ...
  */
  if (cmd_info[cmd].anti_aff && AFF_FLAGGED(ch, cmd_info[cmd].anti_aff)) {
    ...
    if (!IS_NPC(ch) && MEDITATING(ch) && strcmp(cmd_info[cmd].command, "memorize") &&
        strcmp(cmd_info[cmd].command, "scribe")) {
...
void nanny(struct descriptor_data *d, char *arg) {
  ...
  int autokits[NUM_CLASSES][NUMITEMINKIT] = {
      {3022, 3042, 3081, 3076, 3041, 3057, 3102, 3010, 3010, 3010, 3032, 3030, 3030}, /* Warrior */
  ...
  case CON_PASSWORD: /* get pwd for known player	 */
    ...
    if (!*arg)
      ...
      for (temp = descriptor_list; temp; temp = next_d) {
        next_d = temp->next;
        if (temp->character && GET_IDNUM(temp->character) == GET_IDNUM(d->character) &&
            (temp->character != d->character)) {
          flush_queues(temp);
          close_socket(temp);
        }
      }
  ...
  case CON_QCLASS:
    ...
    if (*arg == '\0') {
      ...
      if (GET_RACE(d->character) != RACE_TROLL && GET_CLASS(d->character) != CLASS_NECROMANCER &&
        ...
        if (GET_CLASS(d->character) != CLASS_ASSASSIN && GET_CLASS(d->character) != CLASS_ROGUE &&
        ...
        if (GET_RACE(d->character) == RACE_TROLL || GET_RACE(d->character) == RACE_OGRE ||
            GET_CLASS(d->character) == CLASS_NECROMANCER) {
          GET_ALIGNMENT(d->character) = -1000;
  ...
  case CON_MENU: /* get selection from main menu	 */
    ...
    case '1':
      ...
      for (temp = descriptor_list; temp; temp = temp->next)
        if (!d->connected || d->connected == CON_MEDIT || d->connected == CON_REDIT || d->connected == CON_SEDIT ||
            d->connected == CON_ZEDIT || d->connected == CON_OEDIT)
          playing++;
