...
#define ASPELL(spellname) void(spellname) (struct spell_info_type *sinfo, int waitstate, struct char_data *ch, char *arg, int isobj)
...
/* spell declarations */
#define DO_SPELL(sinfo, spellnum, waitstate, ch, arg, isobj) (*spells[(spellnum)].spell_pointer)(sinfo, waitstate, ch, arg, isobj)
